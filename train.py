...
# python train.py --data BasketballActionRecognition_data.yaml --cfg yolov5x6.yaml --weights pretrained/yolov5x6.pt --epoch 100 --batch-size 12 --device 0 --hyp data\hyps\hyp.scratch-high.yaml --imgsz 1280
# python train.py --data BasketballActionRecognition_data.yaml --cfg yolov5x6.yaml --weights pretrained/yolov5x6.pt --epoch 100 --batch-size 12 --device 0 --hyp data/hyps/hyp.scratch-high.yaml --imgsz 1280
